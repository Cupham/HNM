...
public class ThermalZoneDevice implements Runnable {
    ...
    //Change file
    public static final String My_Sensor_File_Temp = "/root/bluesky/temp";
    public static final String My_Sensor_File_Acer = "\\F\\Java-Eclipse\\temp";
    ...
    public static File getSensorFileAt(int index) {
        return new File(String.format(My_Sensor_File_Acer, index));
    }
